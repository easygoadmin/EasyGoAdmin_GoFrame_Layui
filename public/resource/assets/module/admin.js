layui.define(['layer'], function (exports) {
    ...
    admin.events = {
        ...
        theme: function () {
            ...
            admin.strToWin(option.window).layui.admin.popupRight($.extend({
                id: 'layer-theme', url: option.url || '/resource/assets/libs/templets/tpl-theme.html'
        ...
        note: function () {
            var option = admin.util.deepClone($(this).data());
            admin.strToWin(option.window).layui.admin.popupRight($.extend({
                id: 'layer-note', url: option.url || '/resource/assets/libs/templets/tpl-note.html'
            }, admin.parseLayerOption(option)));
        },
        /* 打开消息 */
        message: function () {
            var option = admin.util.deepClone($(this).data());
            admin.strToWin(option.window).layui.admin.popupRight($.extend({
                id: 'layer-notice', url: option.url || '/resource/assets/libs/templets/tpl-message.html'
            }, admin.parseLayerOption(option)));
        },
        /* 打开修改密码弹窗 */
        psw: function () {
            ...
            admin.strToWin(option.window).layui.admin.open($.extend({
                id: 'layer-psw', title: '修改密码', shade: 0, url: option.url || '/resource/assets/libs/templets/tpl-password.html'
            }, admin.parseLayerOption(option)));
        },
        /* 退出登录 */
        logout: function () {
    ...
    admin.lockScreen = function (url) {
        ...
        console.log(url);
        if (!url) url = '/resource/assets/libs/templets/tpl-lock-screen.html';
